...
private object InertAuditLog : AuditLog {
    ...
    override suspend fun queryRecentRuns(limit: Int): List<io.github.unityinflow.kore.core.port.AgentRunRecord> = emptyList()

    override suspend fun queryCostSummary(): List<io.github.unityinflow.kore.core.port.AgentCostRecord> = emptyList()
}
