package io.github.unityinflow.kore.dashboard

import io.github.unityinflow.kore.core.AgentEvent
                ...
                DashboardDataService(
                    auditLog =
                        SeededAuditLog(
                            ...
                            costs =
                                listOf(
                                    io.github.unityinflow.kore.core.port
...
/** Test double for [io.github.unityinflow.kore.core.port.AuditLog] returning seeded reads. */
private class SeededAuditLog(
    private val runs: List<io.github.unityinflow.kore.core.port.AgentRunRecord>,
    private val costs: List<io.github.unityinflow.kore.core.port.AgentCostRecord>,
) : io.github.unityinflow.kore.core.port.AuditLog {
    ...
    override suspend fun recordAgentRun(
        agentId: String,
        task: io.github.unityinflow.kore.core.AgentTask,
        result: io.github.unityinflow.kore.core.AgentResult,
    ) = Unit

    override suspend fun recordLLMCall(
        agentId: String,
        backend: String,
        usage: io.github.unityinflow.kore.core.TokenUsage,
    ) = Unit

    override suspend fun recordToolCall(
        agentId: String,
        call: io.github.unityinflow.kore.core.ToolCall,
        result: io.github.unityinflow.kore.core.ToolResult,
    ) = Unit
...
private fun fakeRun(
    name: String,
    resultType: String,
): io.github.unityinflow.kore.core.port.AgentRunRecord =
    io.github.unityinflow.kore.core.port.AgentRunRecord(
        agentName = name,
