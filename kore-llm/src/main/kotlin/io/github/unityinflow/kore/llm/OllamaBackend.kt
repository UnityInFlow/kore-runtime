...
/**
 * LLM backend adapter for Ollama using LangChain4j 0.26.1 as HTTP transport only.
 *
 ...
 * [semaphore] defaults to Semaphore(2) — local model has limited parallelism (T-05-04).
 *
 * The [chatModel] parameter is injectable for testing — use the [ollama] factory function
 * in production to build an OllamaChatModel with the correct baseUrl and modelName.
 */
class OllamaBackend(
