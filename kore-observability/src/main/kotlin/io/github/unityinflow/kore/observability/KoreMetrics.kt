...
class KoreMetrics(
    ...
    /**
     * Tracks currently active agents. Goes up on [io.github.unityinflow.kore.core.AgentEvent.AgentStarted],
     * down on [io.github.unityinflow.kore.core.AgentEvent.AgentCompleted]. (D-23 — no labels)
     */
     ...
     * the agent's configured name (from [io.github.unityinflow.kore.core.AgentTask.metadata])
    ...
    /**
     * Incremented on [io.github.unityinflow.kore.core.AgentResult.LLMError] and
     * [io.github.unityinflow.kore.core.AgentResult.ToolError] results.
