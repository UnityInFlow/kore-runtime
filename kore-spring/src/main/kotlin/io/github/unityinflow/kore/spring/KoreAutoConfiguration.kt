...
class KoreAutoConfiguration {
    ...
    // top-level factory functions in io.github.unityinflow.kore.llm.LlmBackends.kt
    // which build the clients from API keys exactly as the DSL does.
    // ───────────────────────────────────────────────────────────────────────

    @Configuration(proxyBeanMethods = false)
    @ConditionalOnClass(name = ["io.github.unityinflow.kore.llm.ClaudeBackend"])
    ...
    class ClaudeLlmAutoConfiguration {
        ...
        fun claudeBackend(properties: KoreProperties): io.github.unityinflow.kore.llm.ClaudeBackend =
            io.github.unityinflow.kore.llm.claude(
    ...
    @Configuration(proxyBeanMethods = false)
    @ConditionalOnClass(name = ["io.github.unityinflow.kore.llm.OpenAiBackend"])
    ...
    class OpenAiLlmAutoConfiguration {
        ...
        fun openAiBackend(properties: KoreProperties): io.github.unityinflow.kore.llm.OpenAiBackend =
            io.github.unityinflow.kore.llm.gpt(
    ...
    @Configuration(proxyBeanMethods = false)
    @ConditionalOnClass(name = ["io.github.unityinflow.kore.llm.OllamaBackend"])
    ...
    class OllamaLlmAutoConfiguration {
        ...
        fun ollamaBackend(properties: KoreProperties): io.github.unityinflow.kore.llm.OllamaBackend =
            io.github.unityinflow.kore.llm.ollama(
    ...
    @Configuration(proxyBeanMethods = false)
    @ConditionalOnClass(name = ["io.github.unityinflow.kore.llm.GeminiBackend"])
    ...
    class GeminiLlmAutoConfiguration {
        ...
        fun geminiBackend(properties: KoreProperties): io.github.unityinflow.kore.llm.GeminiBackend =
            io.github.unityinflow.kore.llm.gemini(
    ...
    @ConditionalOnClass(
        name = [
            "io.github.unityinflow.kore.observability.KoreTracer",
            "io.opentelemetry.api.trace.Tracer",
        ],
    )
    class ObservabilityAutoConfiguration {
        @Bean
        @ConditionalOnMissingBean(io.github.unityinflow.kore.observability.KoreTracer::class)
        fun koreTracer(tracer: io.opentelemetry.api.trace.Tracer): io.github.unityinflow.kore.observability.KoreTracer =
    ...
    @Configuration(proxyBeanMethods = false)
    @ConditionalOnClass(name = ["io.github.unityinflow.kore.skills.SkillRegistryAdapter"])
    ...
    // `io.github.unityinflow.kore.kafka.KafkaEventBus` only resolves when the
    ...
    @Configuration(proxyBeanMethods = false)
    @ConditionalOnClass(name = ["io.github.unityinflow.kore.kafka.KafkaEventBus"])
    @ConditionalOnProperty(
        prefix = "kore.event-bus",
        name = ["type"],
        havingValue = "kafka",
    ...
    @Configuration(proxyBeanMethods = false)
    @ConditionalOnClass(name = ["io.github.unityinflow.kore.rabbitmq.RabbitMqEventBus"])
    @ConditionalOnProperty(
        prefix = "kore.event-bus",
        name = ["type"],
        havingValue = "rabbitmq",
    ...
    class RabbitMqEventBusAutoConfiguration {
        ...
        fun rabbitMqEventBus(
            ...
            io.github.unityinflow.kore.rabbitmq.RabbitMqEventBus(
