...
import io.github.unityinflow.kore.spring.actuator.KoreActuatorEndpoint
...
class KoreAutoConfigurationTest {
    ...
    fun `auto-configures SkillRegistryAdapter as the SkillRegistry bean when kore-skills is on classpath`() {
        ...
        contextRunner.run { context ->
            ...
            bean.shouldBeInstanceOf<io.github.unityinflow.kore.skills.SkillRegistryAdapter>()
        }
    }
        ...
        contextRunner
            .withPropertyValues(
                ...
                val backendBeanNames =
                    context.getBeanNamesForType(io.github.unityinflow.kore.llm.ClaudeBackend::class.java)
    ...
    fun `ClaudeBackend bean is NOT registered when api-key is missing`() {
        contextRunner.run { context ->
            ...
            context.getBeanNamesForType(io.github.unityinflow.kore.llm.ClaudeBackend::class.java).size shouldBe 0
        }
    }
