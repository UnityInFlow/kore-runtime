...
import io.github.unityinflow.kore.dashboard.DashboardServer
import io.github.unityinflow.kore.skills.SkillRegistryAdapter
 ...
 *
 *   add `io.github.unityinflow:kore-spring` → write one `@Bean { agent { } }` →
